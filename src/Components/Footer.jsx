    ...
    >
      <div className="bg-[#E7DCA2]   rounded-3xl sm:rounded-[30px] md:rounded-[40px] overflow-hidden">
        ...
        <div className="overflow-hidden ">
          <h1
            ref={titleRef}
            className="font-footer text-center font-black leading-[0.9] mt-5 text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[11rem]"
          >
            KeepExploring
          </h1>
        </div>
        ...
        <div
          className="
            grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10  px-5 sm:px-8 md:px-10 lg:px-12  py-8  md:py-10
          "
        >
          {/* Navigate */}
